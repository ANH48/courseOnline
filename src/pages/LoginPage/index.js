...
const schema = yup.object().shape({
    ...
    matKhau: yup.string().required("Mật khẩu không đucowj để trống").min(3,"Mật Khẩu  phải từ 3 đến 20 kí tự").max(20,"Mật Khẩu phải từ 3 đến 20 kí tự"),
  });
...
{errors.matKhau && ( <Alert className="alert alert-danger">{errors.matKhau.message}</Alert>)}
